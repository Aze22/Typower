...
public class UISlider : UIWidgetContainer
{
	...
	void Init ()
	{
		...
		{
			Debug.LogWarning("UISlider expected to find a foreground object or a box collider2D to work with", this);
		}
	}
	...
	{
		mTrans = transform;
		mCol = collider2D as BoxCollider2D;
	}
	...
	void Start ()
	{
		...
		if (Application.isPlaying && thumb != null && thumb.collider2D != null)
		{
	...
	void UpdateDrag ()
	{
		...
		// Collider2D's bottom-left corner in local space
