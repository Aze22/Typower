...
static public class NGUITools
{
	...
	static public BoxCollider2D AddWidgetCollider (GameObject go) { return AddWidgetCollider(go, false); }

	/// <summary>
	/// Add a collider to the game object containing one or more widgets.
	/// </summary>

	static public BoxCollider2D AddWidgetCollider (GameObject go, bool considerInactive)
	{
		if (go != null)
		{
	...
	static public void UpdateWidgetCollider (GameObject go, bool considerInactive)
	{
		if (go != null)
		{
			UpdateWidgetCollider(go.GetComponent<BoxCollider2D>(), considerInactive);
		}
	}
	...
	static public void UpdateWidgetCollider (BoxCollider2D bc)
	{
